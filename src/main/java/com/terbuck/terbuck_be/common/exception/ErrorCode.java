...
public enum ErrorCode {
    ...
    AUTH_APPLE_AUTHORIZATION_CODE_NOT_FOUND(HttpStatus.NOT_FOUND.value(), "애플 인증 코드를 통해서 토큰을 발급받지 못했습니다."),
    ...
    COLLEGE_NOT_FOUND(HttpStatus.NOT_EXTENDED.value(), "해당 단과대학이 존재하지 않습니다."),
